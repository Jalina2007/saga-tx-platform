...
import com.example.inventoryservice.dto.StepResultRequest;
import com.example.inventoryservice.dto.StepStateResponse;
...
public class CoordinatorClient {
    ...
    private void updateStep(String xid, Long stepId, StepResultRequest request, String outcome) {
        ...
        if (!response.getStatusCode().is2xxSuccessful()) {
            throw new IllegalStateException("Coordinator step update failed");
        }
    }
}
